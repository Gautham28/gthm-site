...
footer:
  parts:
    ...
    - { type: link, label: X, href: "#" }
    - ", check out my "
    - { type: link, label: digital store, href: "#" }
    - ", or you can always reach me at "
    - { type: link, label: hi@gthm.me, href: "mailto:hi@gthm.me" }
    - "."
...
sections:
  ...
  designWork:
    title: Design Work I Crafted
    subtitle: Client work and design projects
  projects:
